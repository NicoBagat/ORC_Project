...
#------------------------------------------------------------------------------------
# NN MODEL LOADER and NORMALIZATION FUNCTIONS
...
def load_nn_model(single=True, device=None):
    ...
    if single:
        ...
        input_size = model_cfg.get("double_input_size", 4) #4' to be subbed by field call from config file
